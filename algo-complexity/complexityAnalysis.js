...
1-big O(1):'forexample' if we reached to an element inside an array directly without itereating throw
...
log O(n):'forwxample' if we search for one element in an array and we searched part by part from the array 
